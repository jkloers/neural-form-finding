...
def evaluate_unit_cell(
    ...
    applied_displacement : float
        Peak z-displacement of F1 [m] — used when loading_mode='rotation'.
    applied_moment : float
        Bending moment about fold axis [N·m] — used when loading_mode='moment'.
    loading_mode : str
        'rotation' — displacement-controlled (stable, prescribes angle).
        'moment'   — force-controlled (Neumann BC, structure finds equilibrium).
    face_size : float
